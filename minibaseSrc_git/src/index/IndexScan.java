...
public class IndexScan extends Iterator {
  ...
  public IndexScan(
	   ...
	   IndexType     index,   //new IndexType(IndexType.B_Index)     
	   final String  relName, //"test1.in" 
	   final String  indName,  //BTreeIndex
	   AttrType      types[],    //attrType  
	   short         str_sizes[], //attrSize    
	   int           noInFlds,   //2       
	   int           noOutFlds,   //2      
	   FldSpec       outFlds[],    //projlist 
	   CondExpr      selects[],  //null
	   final int     fldNum,//2
	   final boolean indexOnly //true
	   ) 
