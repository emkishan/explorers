...
public class PhaseIIITest {

	private static boolean OK = true;
	private static boolean FAIL = false;
	private static PhaseIIITest jjoin = null;
	SystemDefs sysdef;
...
*/	    //sysdef = new SystemDefs( dbpath, 536870912, 20480, "Clock" );
	...
	public void processTopNRAJoin(){
		...
		try {
	        ...
	        sm = new TopNRAJoin(numRelations, updatedAttrTypeList, numOfColsList, stringSizesList, joinedColList, iteratorList, memory,
	...
	public static void main(String[] args) {
		...
		jjoin = new PhaseIIITest();
		
		//JoinsDriver2 jjoin = new JoinsDriver2();

		System.out.println("DBI Phase III");
