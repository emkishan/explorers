...
public class PhaseIIISCTest implements GlobalConst{

	private static boolean OK = true;
	private static boolean FAIL = false;
	SystemDefs sysdef;
	public PhaseIIISCTest() {
	...
	public static void processStreamCombine()
	{
...
itr = new Sort(attrTypeList[j], (short)attrTypeList[j].length, stringSizesList[j],am, numOfColsList[j], new TupleOrder(TupleOrder.Descending), 4, memory );
	...
	public static void main(String[] args) {
		...
		PhaseIIISCTest jjoin = new PhaseIIISCTest();
